  ...
  return (
    <div className="relative w-full h-[300px] sm:h-[400px] md:h-[500px] mt-10">
      ...
      >
        ...
        <a href="https://efood.efixit.ng/" className='cursor-pointer'>
          <motion.button
            className="mt-4 bg-orange-600 border cursor-pointer border-white px-4 sm:px-6 md:px-8 py-2 sm:py-3 md:py-4 text-sm sm:text-lg md:text-xl font-semibold rounded-lg shadow-lg flex items-center transition-transform transform hover:scale-105 hover:bg-orange-700"
