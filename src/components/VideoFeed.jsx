      ...
      <div className="max-w-7xl mx-auto px-4 py-8 mt-3">
        <div className="mb-8">
          <div className="flex items-center justify-between flex-wrap gap-4">
            <div>
              <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-1 flex items-center gap-3">
                
                Explore Short Videos
              </h2>
              <p className="text-gray-500 text-sm">Watch short videos of amazing places and events</p>
            </div>
            <button 
              onClick={() => navigate('/Shortfeed')}
              className="flex items-center gap-2 px-4 py-2 bg-gray-100 hover:bg-gray-200 rounded-xl text-sm font-medium text-gray-700 transition-colors duration-300"
            >
